...
import CreatDept from '@/views/system/dept/CreatDept'
...
export default function () {
  ...
  const getDeptList = async () => {
    const data = await serverApi.getDeptList(form.getFieldsValue())
    setData(data)
  }
  // 重置
  const handleReset = () => {
  ...
  return (
    <div>
      ...
      <CreatDept modalRef={deptRef} updateList={getDeptList} />
    </div>
  )
}
